module ApplicationHelper
  ...
  @@COLOR_TABLE = ["000000", "FFFF00", "1CE6FF", "FF34FF", "FF4A46", "008941", "006FA6", "A30059",
  ...
  def color_code(id)
    "#"+@@COLOR_TABLE[id % @@COLOR_TABLE.length]
  end

  def contrast_color(id)
    if LuminosityContrast.ratio(@@COLOR_TABLE[id % @@COLOR_TABLE.length], 'ffffff') >= 4.5
      return '#ffffff'
    else
      return '#000000'
    end
